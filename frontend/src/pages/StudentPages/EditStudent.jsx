  ...
  return (
    <div className={styles.container}>
      ...
      <button onClick={()=>navigate('/admin/students')} className={styles.btn}>❌</button>
        <h2 className={styles.title}>Enter Updated Details</h2>
          <p style={{color:(msg!=='Student Upadted Sucessfully!' ? 'red': 'green'),textAlign:'center',fontSize:'20px',paddingBottom:'5px'}}>{msg}</p>
